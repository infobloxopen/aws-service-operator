...
var vpcsResource = schema.GroupVersionResource{Group: "serviceoperator.aws", Version: "v1alpha1", Resource: "vpcs"}

var vpcsKind = schema.GroupVersionKind{Group: "serviceoperator.aws", Version: "v1alpha1", Kind: "Vpc"}
...
func (c *FakeVpcs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Vpc, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(vpcsResource, c.ns, name, data, subresources...), &v1alpha1.Vpc{})
